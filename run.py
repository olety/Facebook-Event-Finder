...
def show_places():
    if request.args.get('id', None):
        ...
        return json.dumps([_.to_dict() for _ in
                          ...
                          default=fbd.toold.default_json_serializer)
    else:
        return json.dumps(s.get_all_place_ids(), default=fbd.toold.default_json_serializer)
...
def show_events():
    if request.args.get('id', None):
        ...
        return json.dumps(s.get_all_event_ids(), default=fbd.toold.default_json_serializer)
